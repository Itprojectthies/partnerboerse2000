...
public class AlternativeMapper {
  ...
  /**
   * Die Klasse AlternativeMapper wird nur einmal instantiiert. Man spricht hierbei
   ...
   * Singleton-Alternative sicher, indem Sie dafür sorgt, dass nur eine einzige
   * Instanz von <code>AlternativeMapper</code> existiert.
   * <p>
   * 
...
//        result.addElement(a);
  ...
  /**
   * Einfügen eines <code>Alternative</code>-Objekts in die Datenbank. Dabei wird
...
//     * Objekte übergeben werden, wäre die Anpassung des Alternative-Objekts auch
...
//
//  /**
//   * Löschen der Daten eines <code>Alternative</code>-Objekts aus der Datenbank.
//   * 
