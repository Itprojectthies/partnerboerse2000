...
public class KontaktsperreMapper {
  ...
  /**
   * Die Klasse KontaktsperreMapper wird nur einmal instantiiert. Man spricht hierbei
   ...
   * Singleton-Kontaktsperre sicher, indem Sie dafür sorgt, dass nur eine einzige
   * Instanz von <code>KontaktsperreMapper</code> existiert.
   * <p>
   * 
...
//     * Objekte übergeben werden, wäre die Anpassung des Kontaktsperre-Objekts auch
