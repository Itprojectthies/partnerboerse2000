...
public class ProfilMapper {
  ...
  public Profil findByKey(int id) {
    ...
    try {
      ...
      ResultSet rs = stmt
          .executeQuery("SELECT id, Vorname, Nachname, Email, Haarfarbe, Koerpergroesse, Raucher, Religion, Geschlecht FROM Profil "
  ...
  public ArrayList<Profil> findAll() {
    ...
    try {
      ...
      ResultSet rs = stmt.executeQuery("SELECT id, Vorname, Nachname, Email, Haarfarbe, Koerpergroesse, Raucher, Religion, Geschlecht "
  ...
  public ArrayList<Profil> findByLastName(String name) {
    ...
    try {
      ...
      ResultSet rs = stmt.executeQuery("SELECT id, Vorname, Nachname, Email, Haarfarbe, Koerpergroesse, Raucher, Religion, Geschlecht "
          + "FROM Profil " + "WHERE Nachname LIKE '" + name
          + "' ORDER BY Nachname");
  ...
  public Profil update(Profil p) {
    ...
    try {
      ...
      stmt.executeUpdate("UPDATE Profil " + "SET Vorname=\""
          + p.getVorname() + "\", " 
  ...
  public void setVisited(Profil a, Profil b){
	  //soll in Besuchertabelle schreiben wann wer wen besucht hat. und eine Variable "visited" true setzen
