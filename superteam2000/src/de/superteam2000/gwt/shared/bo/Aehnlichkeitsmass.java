...
/**
* Hier wird ein exemplarisches Ähnlichkeitsmass eines Users realisiert.
* Anhand diesem kann berechnet werden, wie ähnlich sich das Profil eines User mit den anderen Profilen
* der Partnerbörse sind. 
* 
...
public class Aehnlichkeitsmass extends BusinessObject {
	...
	/**
	 * Berechnung des Ähnlichkeitsmaßes
	 * Das berechnete Ähnlichkeitsmaß zweier Profil wird in einer ArrayList vom Typ Profil gespeichert.
	 * @param p
	 * @param referenz
	 * @return null
	 */	
