...
/**
 * Hier wird ein exemplarisches Suchprofil eines Users realisiert. Anhand eines Suchprofils
 * können andere User gesucht werden. Die gesuchten Profile werden dann nach dem
 * Ähnlichkeitsmaß sortiert.
 * 
...
public class Suchprofil extends BusinessObject {
	 ...
	 * @param groesse_min User hat die Möglichkeit bei einem Suchprofil anzugeben, wie groß der gesuchte User mindestens sein soll.
	...
	/**
	 * Feststellen der inhaltlichen Gleichheit zweier Suchprofil-Objekte
	 * anhand der eindeutigen Profil-ID eines Suchprofils.
