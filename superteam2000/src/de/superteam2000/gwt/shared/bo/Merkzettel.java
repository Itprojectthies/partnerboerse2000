...
/**
 * Hier wird ein exemplarischer Merkzettel eines Profils realisiert.
 * Ein User kann sich Profile, die ihm gefallen, merken. 
 * Die gemerkten Profile können durch den Merkzettel angezeigt werden.
 * 
...
public class Merkzettel extends BusinessObject {
	 ...
	 * @param gemerkteProfile Dieser Parameter ist eine ArrayList vom Typ Profil. In dieser ArrayList werden alle gemerkten Profile gespeichert.
