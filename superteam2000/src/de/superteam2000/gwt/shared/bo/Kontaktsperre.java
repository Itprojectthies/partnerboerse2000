...
/**
 * Hier wird eine exemplarische Kontaktperre eines Users realisiert.
 * Ein User kann sich Profile, die ihm nicht gefallen, sperren lassen. 
 * Die gesperrten Profile können durch die Sperrliste angezeigt werden.
 * 
...
public class Kontaktsperre extends BusinessObject {
	 ...
	 * @param gesperrteProfile Dieser Parameter ist eine ArrayList vom Typ Profil. In dieser ArrayList werden alle gesperrte Profile gespeichert.
