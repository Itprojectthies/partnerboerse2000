 ...
 * <code>Report</code>-Objekte in ein menschenlesbares Format zu überführen.
 * </p>
 * <p>
 * Das Zielformat kann prinzipiell beliebig sein. Methoden zum Auslesen der in das Zielformat
 * überführten Information wird den Subklassen überlassen. In dieser Klasse werden die Signaturen
...
public abstract class ReportWriter {
  ...
  /**
   * Übersetzen eines <code>AllAccountsOfCustomerReport</code> in das Zielformat.
   *
  ...
  /**
   * Übersetzen eines <code>AllAccountsOfAllCustomersReport</code> in das Zielformat.
   *
   * @param r der zu übersetzende Report
   */
