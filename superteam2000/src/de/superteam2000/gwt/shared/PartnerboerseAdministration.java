...
// Info 
		public Info createInfoFor(Profil profil, Auswahl auswahl) 
				throws IllegalArgumentException;
		public Info createInfoFor(Profil profil, Beschreibung beschreibung) 
				throws IllegalArgumentException;
		public void saveInfoForProfil(Profil profil, Info info)
				throws IllegalArgumentException;
		public void deleteInfoForProfil(Profil profil, Info info)
				throws IllegalArgumentException;
		public ArrayList<Info> getInfoByProfile(Profil profil) 
				throws IllegalArgumentException;
		public ArrayList<Info> getInfoByEigenschaftsId(int id)
				throws IllegalArgumentException;
