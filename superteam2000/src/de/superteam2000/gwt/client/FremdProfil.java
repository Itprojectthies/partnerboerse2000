    ...
    public void onClick(ClickEvent event) {
      if (profil != null) {
        ClientsideSettings.getPartnerboerseVerwaltung()
            .createSperre(ClientsideSettings.getCurrentUser(), profil, new AsyncCallback<Void>() {
  ...
  public class MerkenButtonClickhandler implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      if (profil != null) {
        ...
        ClientsideSettings.getPartnerboerseVerwaltung()
            .createMerken(ClientsideSettings.getCurrentUser(), profil, new AsyncCallback<Void>() {
