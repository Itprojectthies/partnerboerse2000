...
public class ClientsideSettings extends CommonSettings {
   ...
   * Auskommentieren etwa von <code>System.out.println(...);</code> steuern. Sie belassen künftig
   * sämtliches Logging im Code und können ohne abermaliges Kompilieren den Log Level "von außen"
   * durch die Datei <code>logging.properties</code> steuern. Sie finden diese Datei in Ihrem
   * <code>war/WEB-INF</code>-Ordner. Der dort standardmäßig vorgegebene Log Level ist
   * <code>WARN</code>. Dies würde bedeuten, dass Sie keine <code>INFO</code>-Meldungen wohl aber
   * <code>WARN</code>- und <code>SEVERE</code>-Meldungen erhielten. Wenn Sie also auch Log des
  ...
  /**
   * <p>
   * Anlegen und Auslesen der applikationsweit eindeutigen BankAdministration. Diese Methode
