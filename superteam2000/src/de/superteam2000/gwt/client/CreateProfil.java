...
public class CreateProfil extends BasicFrame {
	...
	public void run() {
		...
		groesse = new ProfilAttributeBoxPanel("Was ist deine KÃ¶rpergrÃ¶ÃŸe?");
	...
	/**
	 * Die beiden Attribute Groesse und Geburtstag werden dem Panel hinzugefügt
	 * 
	...
	private class ConfirmClickHandler implements ClickHandler {
		 ...
		 * @param groesse gibt Mindestwert für Koerpergroesse vor
		 */
		@Override
